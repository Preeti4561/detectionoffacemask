...
for i in range(1,32):
    sh1.write(0,4+i,i)'''
#wb.save(r'C:\Users\SauR\Desktop\AI Project\db.xls')
#print('Database is created Successfully')


import xlrd
rb=xlrd.open_workbook(r'C:\Users\SauR\Desktop\AI Project\db.xls')
print(rb.nsheets)
...
while(op==1):
    ...
    shd0.write(rn,4,idd)
    url=pqr.create(idd)
    url.png(r'C:\Users\SauR\Desktop\AI Project\QRDB'+'\\'+idd+'.png',scale=10)
    op=int(input('would you like to continue'))
    rn=rn+1
wbb.save(r'C:\Users\SauR\Desktop\AI Project\db.xls')
